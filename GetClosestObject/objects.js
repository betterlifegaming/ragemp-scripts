...
exports.checkLocalObjectsFirst = function(player) {
    ...
    var tankflight = mp.game.joaat("prop_ind_deiseltank");
    // Locker
    ...
    var fuelflight = mp.game.object.getClosestObjectOfType(player.position.x, player.position.y, player.position.z, 5, tankflight, false, true, true);
    ...
    var tonne6 = mp.game.object.getClosestObjectOfType(player.position.x, player.position.y, player.position.z, 1.5, 1437508529, false, true, true);
    var tonne7 = mp.game.object.getClosestObjectOfType(player.position.x, player.position.y, player.position.z, 1.5, 4236481708, false, true, true);
    var tonne8 = mp.game.object.getClosestObjectOfType(player.position.x, player.position.y, player.position.z, 1.5, 1614656839, false, true, true);
    var tonne9 = mp.game.object.getClosestObjectOfType(player.position.x, player.position.y, player.position.z, 1.5, 4164154385, false, true, true);
    var tonne10 = mp.game.object.getClosestObjectOfType(player.position.x, player.position.y, player.position.z, 1.5, 651101403, false, true, true);
    var tonne11 = mp.game.object.getClosestObjectOfType(player.position.x, player.position.y, player.position.z, 1.5, 3198190107, false, true, true);
    var tonne12 = mp.game.object.getClosestObjectOfType(player.position.x, player.position.y, player.position.z, 1.5, 1143474856, false, true, true);
    var tonne13 = mp.game.object.getClosestObjectOfType(player.position.x, player.position.y, player.position.z, 1.5, 3826337632, false, true, true);
    var tonne14 = mp.game.object.getClosestObjectOfType(player.position.x, player.position.y, player.position.z, 1.5, 2198842852, false, true, true);
    var tonne15 = mp.game.object.getClosestObjectOfType(player.position.x, player.position.y, player.position.z, 1.5, 3965551402, false, true, true);
    ...
    if (atm1 || atm2 || atm3 || atm4) {
        ...
        return "donut";
    } else if (tonne1 || tonne2 || tonne3 || tonne4 || tonne5 || tonne7) {
        return "dump";
    } else if (tonne6 || tonne8 || tonne9 || tonne10 || tonne11 || tonne12 || tonne13 || tonne14 || tonne15) {
        return "dumpsmall";

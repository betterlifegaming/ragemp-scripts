let deathReasons = {
  ...
  "133987706": "Hit by Car",
  "2741846334": "Run over by Car",
  "3452007600": "Fall",
  "4194021054": "Animal",
  "324506233": "Airstrike Rocket",
  "2339582971": "Blood loss",
  "2294779575": "Case",
  "28811031": "Case",
  "148160082": "Mountain Lion",
...
mp.events.add("playerDeath", (player, reason, killer) => {
  if (mp.players.exists(player) && mp.players.exists(killer)) {
    console.log(player.id+" killed by "+killer.id+". Reason: "+deathReasons[String(reason)]);
  }
});
